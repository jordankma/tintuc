            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href=""><i class="fa fa-users fa-fw"></i>Quản lý tin hot<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/quanly/tinhot">Hot top home</a>
                                </li>
                                <li>
                                    <a href="admin/quanly/tinhotcategory">Hot top category</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
